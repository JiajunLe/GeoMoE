...
net_arg.add_argument(
    "--channels", type=int, default=128, help=""
    "number of channels in a layer. Default: 64")
net_arg.add_argument(
...
net_arg.add_argument(
    "--num_experts", type=int, default=4, help=""
    "number of expert in MoE. Default: 48")
net_arg.add_argument(
    "--num_experts_per_tok", type=int, default=2, help=""
    "number of expert in MoE. Default: 48")
net_arg.add_argument(
    "--head", type=int, default=4, help=""
    "number of head in attention. Default: 4")
net_arg.add_argument(
    "--pattern_num", type=int, default=48, help=""
    "number of indices in SparseDMFCNet. Default: 48")
net_arg.add_argument(
    "--num_block", type=int, default=8, help=""
...
data_arg.add_argument(
    "--data_tr", type=str, default='../dataset/yfcc-sift-2000-train.hdf5', help=""
    "name of the dataset for train")
data_arg.add_argument(
    "--data_va", type=str, default='../dataset/yfcc-sift-2000-val.hdf5', help=""
    "name of the dataset for valid")
data_arg.add_argument(
    "--data_te", type=str, default='../dataset/yfcc-sift-2000-test.hdf5', help=""
...
loss_arg.add_argument(
    ...
    "momentum")
loss_arg.add_argument(
    "--loss_balance", type=float, default=0.01, help=""
...
train_arg.add_argument(
    "--log_suffix", type=str, default="geomoe", help=""
    "suffix of log dir")
train_arg.add_argument(
